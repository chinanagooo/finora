...
Finora is a single-page web application that gives Singaporeans a real-time picture of their financial health. It combines a secure login system, a dynamic Wellness Score engine, an interactive Scenario Lab, a prioritised Action Centre, and a Bloomberg-inspired analytics panel — all running entirely in the browser with no backend and no data leaving your device.
